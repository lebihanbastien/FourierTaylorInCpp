...
#-----------------------------------------------------
REFST_TYPE=$REF_CONT_D #$REF_CONT            # Type of refinement - rk: set REF_CONT_D_HARD_CASE for difficult cases with REF_CONT_D (ex: EML2-SEMLi via SEML1...)
...
REFST_SI_CMU_EM_LIM=(-18 -12 0 0 18 24 0 0)
...
FILE_PCU="Serv/projcu_order_20_dest_L2_t0_099T.bin"
FILE_CONT="phd_cont_atf_order_20_dest_L2_t0_0.99_fam7_leg2.txt"
FILE_CONT_RES="phd_cont_atf_traj_order_20_dest_L2_t0_0.99_fam7_leg2.bin"
...
REFST_MPLOT=500        	         # number of points per plot between to pach points (e.g. total plot points is REFST_MPLOT*REFST_GRIDSIZE)
REFST_FPLOT=5                    # frequency of plotting in hours

REFST_TIME=$REF_VAR_TIME		 # type of constraints on the times in REF_CONT
