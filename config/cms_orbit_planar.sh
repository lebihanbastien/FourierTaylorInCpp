...
REFST_SI_SEED_EM_LIM=(40 40 -100 +100 -100 +100 -100 +100)
...
if [ $SERVER == 1 ]; then
	FILE_PCU="projcu_order_20_dest_L2_Orbit_10_40_eps_1e-5.bin" #"Serv/projcu_order_20_dest_L2_orbit.bin" #"Serv/projcu_order_20_dest_L2_QHalo.bin"  projcu_order_20_dest_L2_Orbit_Liss_s1_10_s2_2
	FILE_CONT="cont_atf_order_20_dest_L2_Planar_s1_40_DIST_SEM_5e-4_TSPAN_SEM_40.txt"
	FILE_CONT_RES="cont_atf_traj_order_20_dest_L2_Planar_s1_40_DIST_SEM_5e-4_TSPAN_SEM_40.bin"
	FILE_TRAJ_FROM_W="traj_from_w_order_20_dest_L2_Planar_s1_40_DIST_SEM_5e-4_TSPAN_SEM_40.bin"
	FILE_TRAJ_FROM_C="traj_from_c_order_20_dest_L2_Planar_s1_40_DIST_SEM_5e-4_TSPAN_SEM_40.bin" 
	FILE_JPL="cont_jpl_order_20_dest_L2_Planar_s1_40_DIST_SEM_5e-4_TSPAN_SEM_40.bin"
	FILE_JPL_TEMP="cont_jpl_temp_40.txt"
else
