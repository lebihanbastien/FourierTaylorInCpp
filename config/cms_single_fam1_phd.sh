...
FILE_CONT="phd_cont_atf_order_20_dest_L2_t0_0.99_fam1_single.txt"
FILE_CONT_RES="phd_cont_atf_traj_order_20_dest_L2_t0_0.99_fam1_single.bin"
...
REFST_TSPAN_SEM=0.1  	 # given as %T, where T is the SEM period, in SEM units
