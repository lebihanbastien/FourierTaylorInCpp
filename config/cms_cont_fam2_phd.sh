...
REFST_SI_CMU_EM_LIM=(12 18 0 0 -35 -30 0 0)
...
REFST_THETAMAX=360           # should be a multiple of 90°



# Filenames (used only if IO_HANDLING==$IO_BASH)
FILE_PCU="Serv/projcu_order_20_dest_L2_t0_099T.bin"
FILE_CONT="cont_atf_order_20_dest_L2_t0_0.99_fam8_leg2.txt"
FILE_CONT_RES="cont_atf_traj_order_20_dest_L2_t0_0.99_fam8_leg2.bin"
...
REFST_FPLOT=2                    # frequency of plotting in hours

REFST_TIME=$REF_FIXED_TIME		 # type of constraints on the times in REF_CONT
