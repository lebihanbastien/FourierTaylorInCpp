...
REFST_SI_CMU_EM_LIM=(-35 -6 0 0 6 14 0 0)
...
REFST_THETAMAX=0            # should be a multiple of 90°



# Filenames (used only if IO_HANDLING==$IO_BASH)
FILE_PCU="Serv/projcu_order_20_dest_L2_t0_099T.bin"
FILE_CONT="phd_cont_atf_order_20_dest_L2_t0_0.99_fam6_leg2.txt"
FILE_CONT_RES="phd_cont_atf_traj_order_20_dest_L2_t0_0.99_fam6_leg2.bin"
