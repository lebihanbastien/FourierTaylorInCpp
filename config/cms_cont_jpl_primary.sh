...
#
# Specifically made to detect the primary family.
# Note that the family is detected only if the maximum step in
# variable time is BIG.
#
...
REFST_SI_CMU_EM_LIM=(-30 -26 0 0 -22 -18 0 0)
...
FILE_PCU="projcu.bin"
FILE_CONT="Serv/cont_atf_order_20_dest_L2_t0_0.995_fam1.txt"
