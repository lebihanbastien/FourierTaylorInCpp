...
//Precision
#define PREC_ABS 1e-15
#define PREC_REL 1e-15
...
void init_QBCP_I(QBCP_I *model, QBCP_L *model1, QBCP_L *model2, int n1, int n2, int n3, int isNormalized, int li_EM, int li_SEM, int isNew, int mod1, int mod2, int fwrk, int pmType1, int pmType2);
 ...
 **/
void init_env(int li_EM, int li_SEM, int isNormalized, int model, int fwrk,  int pmStyle_EM, int pmStyle_SEM, int manType_EM, int manType_SEM);
